...
final class WayrepoReader implements java.io.Closeable
{
    ...
    /** Constructs a WayrepoReader.  Call {@linkplain #close close}() when done with it.
      ...
      *       See {@linkplain Wayranging#wayrepoTreeLoc_message(String) wayrepoTreeLoc_message}.
      */
      ...
      throws WayrepoX
    {
        ...
        {
            throw new WayrepoX( Wayranging.wayrepoTreeLoc_message(wayrepoTreeUri.toString()), x );
        }
    }
