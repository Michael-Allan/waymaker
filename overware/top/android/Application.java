...
public @ThreadRestricted("app main") final class Application extends android.app.Application
{
    ...
    static { System.setProperty( "overware.g.LoggerX.classPrefix", "ov" ); }
   ...
   // --------------------------------------------------------------------------------------------------
    ...
    /** The general preference store for this application.
      *
      *     @see Overguidance#registerStrongly(SharedPreferences.OnSharedPreferenceChangeListener)
      */
    ...
    /** Configures a parser factory for Overware XHTML documents.
      *
