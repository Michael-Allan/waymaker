...
interface Node
{
    ...
    /** A comparator that sorts nodes by {@linkplain #peerOrdinal() peer ordinal} (low to high), then by
      ...
      * {@linkplain GuidewayCount#enqueuePeersRequest(VotingID,PeersReceiver,int) guideway count}.
      */
   ...
   // - N o d e ----------------------------------------------------------------------------------------
    ...
    /** This node’s ordinal number as a peer.  The ordinal number serves to page the data received from
      * the {@linkplain GuidewayCount#enqueuePeersRequest(VotingID,PeersReceiver,int) guideway count}.
      *
      *     @see <a href='../../../../peer' target='_top'>‘peer’</a>
      *     @see GuidewayCount#enqueuePeersRequest(VotingID,PeersReceiver,int,int)
      */
